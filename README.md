...
[comment]: <>Note that the actual original English texts are not included in this dataset, although alignment to the source data is maintained and cross-lingual research is possible.
